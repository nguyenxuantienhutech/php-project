    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="title text-xs-center m-b-30">
                <h2>Newest product of the Month</h2>
            ...
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">These are the most popular products in our shop.</p>
            </div>
            <div class="row">
                <?php
                $query_res = mysqli_query($db, "SELECT title, COUNT(*) as quantity FROM users_orders GROUP BY u_id ORDER BY quantity DESC;");
                while ($r = mysqli_fetch_array($query_res)) {
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/' . $r['img'] . '"></div>
